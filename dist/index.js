...
const writeFile_1 = __nccwpck_require__(196);
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield (0, writeFile_1.writeDotNpmrc)(npmrc, workingDirectory);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.writeDotNpmrc = void 0;
const fs_1 = __importDefault(__nccwpck_require__(147));
const writeDotNpmrc = (npmrc, workingDirectory) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        fs_1.default.writeFile(`${workingDirectory}/.npmrc`, npmrc, err => {
            if (err) {
                reject(err);
            }
            else {
...
exports.writeDotNpmrc = writeDotNpmrc;
